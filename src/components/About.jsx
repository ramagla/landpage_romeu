            ...
            <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.78fr_1.22fr] lg:gap-14">
                <div>
                    ...
                    <h2 id="about-title" className="mt-5 font-display text-4xl font-semibold leading-none tracking-[-0.03em] text-[#201b15] md:text-6xl">
                        À frente da RF Beauty Artist
                    </h2>
                </div>

                <div className="space-y-6 text-base leading-8 text-[#4b4135] md:text-lg md:leading-9">
                    <p>
                        Desde 2002, Romeu Ferrazin atua no mercado da beleza transformando autoestima por meio de cabelo, maquiagem e visagismo. À frente da RF Beauty Artist, une experiência, sensibilidade estética e atendimento personalizado para valorizar a beleza única de cada cliente.
                    </p>
                    <p>
